package com.root.gmall.realtime.common.constant;

public class Constant {
    public static final String KAFKA_BROKERS = "47.94.196.219:9092,39.105.176.215:9092,123.56.98.85:9092";

    public static final String TOPIC_DB = "topic_db";
    public static final String TOPIC_LOG = "topic_log";

    public static final String MYSQL_HOST = "47.94.196.219";
    ...
    public static final String HBASE_ZOOKEEPER_QUORUM = "47.94.196.219,39.105.176.215,123.56.98.85";
    public static final String MYSQL_DRIVER = "com.mysql.cj.jdbc.Driver";
    public static final String MYSQL_URL = "jdbc:mysql://47.94.196.219:3306?useSSL=false";
